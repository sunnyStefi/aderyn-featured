...
#[derive(Default)]
pub struct ResettingStateVariableDetector {
...
*/
impl IssueDetector for ResettingStateVariableDetector {
    ...
    fn title(&self) -> String {
        String::from("State variable value is assigned without being checked first.")
    }
    ...
    fn name(&self) -> String {
        format!("{}", IssueDetectorNamePool::ResettingStateVariable)
    }
}
