...
- [Low Issues](#low-issues)
  ...
  - [L-24: Multiple address(this) calls inside the contract <contract-name> can cause uncecessary gas consumption.](#l-24-multiple-addressthis-calls-inside-the-contract-contract-name-can-cause-uncecessary-gas-consumption)
...
| src/RepeatedAddressThis.sol | 10 |
...
| src/temp/RepeatedAddressThis.sol | 15 |
...
- Found in src/temp/RepeatedAddressThis.sol [Line: 5](tests/contract-playground/src/temp/RepeatedAddressThis.sol#L5)
...
## L-24: Multiple address(this) calls inside the contract <contract-name> can cause uncecessary gas consumption.
...
- Found in src/RepeatedAddressThis.sol [Line: 6](tests/contract-playground/src/RepeatedAddressThis.sol#L6)

	```solidity
	        address test1 = address(this);
	```

- Found in src/RepeatedAddressThis.sol [Line: 10](tests/contract-playground/src/RepeatedAddressThis.sol#L10)

	```solidity
	        address test = address(this);
	```

- Found in src/temp/RepeatedAddressThis.sol [Line: 12](tests/contract-playground/src/temp/RepeatedAddressThis.sol#L12)

	```solidity
	        address test1 = address(this);
	```

- Found in src/temp/RepeatedAddressThis.sol [Line: 17](tests/contract-playground/src/temp/RepeatedAddressThis.sol#L17)
