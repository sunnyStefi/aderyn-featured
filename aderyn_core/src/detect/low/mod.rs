...
pub(crate) mod repeated_address_this;
pub(crate) mod require_with_string;
pub(crate) mod resetting_state_variable;
...
pub(crate) mod single_use_state_variable;
...
pub use repeated_address_this::RepeatedAddressThisDetector;
pub use require_with_string::RequireWithStringDetector;
pub use resetting_state_variable::ResettingStateVariableDetector;
...
pub use single_use_state_variable::SingleUseStateVariableDetector;